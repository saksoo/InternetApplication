...
<%
	...
	try{  
		...
		String queryString = "UPDATE project SET view=? WHERE name=?";
		pstatement = connection.prepareStatement(queryString);
		pstatement.setString(1,vi);
		pstatement.setString(2,nm);
		updateQuery = pstatement.executeUpdate();
		
		if (updateQuery != 0) { 
			%>	
			<h1>Αλλαγή κατάστασης έργου</h1>
			<br />
			...
			<h1>Αλλαγή κατάστασης έργου</h1>
			<br />
			<p><span style="color:red;">Υπήρξε κάποιο πρόβλημα κατά την αλλαγή της κατάστασης. Παρακαλούμε προσπαθήστε ξανά αργότερα.</span></p>
			<br />
			<p><a href="project_list.jsp">Επιστροφή στον κατάλογο των έργων</a></p>		
			<%
	}
